<footer class="relative z-10 bg-primaryColor pt-20 pb-10 px-16 mt-20">
    <div class="container mx-auto">
        <div class="flex flex-wrap -mx-4">
            <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
                <div class="w-full mb-10">
                    <a href="/" class="mb-6 inline-block w-32 ">
                        <img src="{{ asset('assets/logo.png') }}" alt="logo" class="w-20 h-20 object-cover" />
                    </a>
                    <p class="text-sm md:text-lg font-medium text-white mb-7">
                    ...
                    <p class="flex items-center text-sm font-medium text-white">
                        ...
                        <span class="text-sm md:text-md">0274 - 876463</span>
                    </p>
                </div>
            </div>
            <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
                <div class="w-full mb-10">
                    <h4 class="text-lg md:text-xl font-bold text-white mb-2 md:mb-9">
                        Tentang Kami
                    </h4>
                    <ul class="space-y-2">
                        <li>
            ...
            <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
                <div class="w-full mb-10">
                    <h4 class="text-md  md:text-xl font-bold text-white mb-2 md:mb-9">
                        Menu
                    </h4>
                    <ul class="space-y-2">
                        <li>
            ...
            <div class="w-full px-4 sm:w-1/2 lg:w-3/12">
                <div class="w-full mb-10">
                    ...
                    <p class="text-sm md:text-lg text-white">
                        &copy; 2024 Dut`s Coffee. All Rights Reserved
                    </p>
                </div>
            </div>
        </div>
